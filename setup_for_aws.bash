...
alias awsShowStsIdentity="aws sts get-caller-identity"

alias awsCodeCommitCustomizeCT=" \
    aws codepipeline get-pipeline-state --name Custom-Control-Tower-CodePipeline | \
    jq -r ' .stageStates[] | [.stageName, .actionStates[0].latestExecution.status] | @csv ' \
    "
...
alias sshec2='ssh -l ec2-user -i \$PRIVATEKEY'
alias scpec2='scp -l ec2-user -i \$PRIVATEKEY'
